...
// #define MASTER_BRIGHTNESS   18
#define MASTER_BRIGHTNESS   36    // change this to change overall brightness
...
const TProgmemRGBPalette16 JaredColors_p FL_PROGMEM =
{
    CRGB::MidnightBlue,
    CRGB::DarkBlue,
    CRGB::SeaGreen,
...
void loop()
{
 //Un-comment the line with the colors you like best 
  ...
  gPalette = JaredColors_p;
  colortwinkles();
  FastLED.show();  
  FastLED.delay(35);       // change this to change overall speed
  // FastLED.delay(35);       // change this to change overall speed
}
